...
heroText: JkMoney 极客财富
tagline: 专注互联网信息和技术分享，搞钱相关的学习和研究
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 信息
    details: 一些最新互联网科技信息和见解
    link: /categories/?category=信息 # 可选
    imgUrl: /img/info.png # 可选
  - title: 技术
    details: 一些值得分享的技术和技巧
    link: /skill/
    imgUrl: /img/skill.png
  - title: 搞钱
    details: 搞钱相关的信息和方法收集
    link: /money/
